...
class ShippingPage(BasePage):
    ...
    def address_line1_input(self) -> Locator:
        return self.page.locator("#id_shipping_address_line1")

    @property
    def address_line2_input(self) -> Locator:
        return self.page.locator("#id_shipping_address_line2")

    @property
    def city_input(self) -> Locator:
        return self.page.locator("#id_shipping_city")

    @property
    def postal_code_input(self) -> Locator:
        return self.page.locator("#id_shipping_postal_code")

    @property
    def country_input(self) -> Locator:
        return self.page.locator("#id_shipping_country")
